...
perl -l -p -e 's/^typedef unsigned int wchar_t;\z$n//mg' libnx_bindings/libnx_pp8.c > libnx_bindings/libnx_pp9.c
perl -l -p -e 's/__inline/inline/mg' libnx_bindings/libnx_pp9.c > libnx_bindings/libnx_pp10.c
perl -l -p -e 's/^extern struct in_addr __nxlink_host;\z$n//mg' libnx_bindings/libnx_pp10.c > libnx_bindings/libnx_pp11.c
perl -0 -l -p -e 's/ static inline uint32_t $n__crc32.*$n\{$n(.*)$n\}$n//smg' libnx_bindings/libnx_pp11.c > libnx_bindings/libnx_pp12.c
perl -0 -l -p -e 's/static inline u32 crc32.* \{$n(.*)$n\}$n//smg' libnx_bindings/libnx_pp12.c > libnx_bindings/libnx_pp13.c
perl -0 -l -p -e 's/int pselect \(.*\)$n *;$n//smg' libnx_bindings/libnx_pp13.c > libnx_bindings/libnx_pp14.c

printf '%%module libnx\n%%{\n#include <switch.h>\n%%}\n' > libnx_bindings/libnx_header_swig.c

cat libnx_bindings/libnx_header_swig.c libnx_bindings/libnx_pp14.c > libnx_bindings/libnx.i
